...
The database URL and the target metadata come from the application itself, so a
migration can never drift from the configured database.
"""
...
async def run_async_migrations() -> None:
    """Open an async engine and run the migrations inside it."""
